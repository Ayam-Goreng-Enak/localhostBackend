...
class Outfit(db.Model):
    ...
    id_kategori = db.Column(db.BIGINT, db.ForeignKey("kategori.id_kategori"), nullable=True)
    ...
    id_style = db.Column(db.BIGINT, db.ForeignKey("style.id_style"), nullable=True)
    warna = db.Column(db.String(150), nullable=False)
    nama_outfit = db.Column(db.String(100), nullable=False)
    harga_sewa = db.Column(db.Integer, nullable=True)
    harga_beli = db.Column(db.Integer, nullable=True)
    # ukuran = db.Column(db.String(20), nullable=False)
    deskripsi = db.Column(db.String(500), nullable=False)
    detail_produk = db.Column(db.String(300), nullable=True)
